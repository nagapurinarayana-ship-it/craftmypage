        ...
        <div className="cmp-container relative py-16 sm:py-20 lg:py-24">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-6 text-4xl font-black tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
              Beautiful invoices, invitations and resumes without the complexity.
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600 sm:text-xl">
              Create a professional invoice, design an invitation or build a resume directly in your browser.
              Choose a template, customize it and download the finished PDF or image with no account required.
            </p>

            <div className="mt-8 grid gap-3 sm:max-w-3xl sm:grid-cols-3">
              <Link to="/tools/invoice-maker" className="cmp-primary-btn justify-center">
                Create an invoice
              </Link>
              <Link to="/tools/invitation-maker" className="cmp-secondary-btn justify-center">
                Create an invitation
              </Link>
              <Link to="/tools/resume-builder" className="cmp-secondary-btn justify-center">
                Build a resume
              </Link>
            </div>
      ...
      <div className="cmp-container py-12 sm:py-16">
        <section aria-labelledby="tools-heading">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-slate-600">
              Invoice creation is front and center, with the invitation and resume editors one click away.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-3">
            {tools.map((tool) => (
              <Link
                key={tool.href}
                to={tool.href}
                className={`cmp-card group relative ${tool.featured ? 'border-emerald-200 bg-gradient-to-br from-emerald-50 via-white to-teal-50 shadow-md ring-1 ring-emerald-100' : ''}`}
              >
                {tool.featured && (
        ...
        <section className="mt-16">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {[
              ['01', 'Choose a template', 'Start with a focused template for the invoice, invitation or resume you need.'],
