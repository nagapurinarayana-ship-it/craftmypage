...
function loadTemplates(): Template[] {
  ...
  for (const path of Object.keys(templateModules)) {
    // example-template.json is developer fixture content and must never appear in the production gallery.
